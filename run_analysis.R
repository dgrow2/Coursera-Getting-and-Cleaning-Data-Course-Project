...
unzip(zipfile="C:/Users/Doug/Dropbox/r/data.zip", exdir ="C:/Users/Doug/Dropbox/r/data") #unzips the data folder and puts into a new folder, data
...
#test data
subject_test<-read.table("C:/Users/Doug/dropbox/r/data/UCI HAR Dataset/test/subject_test.txt")
X_test<-read.table("C:/Users/Doug/Dropbox/r/data/UCI HAR Dataset/test/X_test.txt")
Y_test<-read.table("C:/Users/Doug/Dropbox/r/data/UCI HAR Dataset/test/y_test.txt")

#train data
subject_train<-read.table("C:/Users/Doug/Dropbox/r/data/UCI HAR Dataset/train/subject_train.txt")
X_train<-read.table("C:/Users/Doug/Dropbox/r/data/UCI HAR Dataset/train/X_train.txt")
Y_train<-read.table("C:/Users/Doug/Dropbox/r/data/UCI HAR Dataset/train/y_train.txt")

#features
features<-read.table("C:/Users/Doug/Dropbox/R/data/UCI HAR Dataset/features.txt")

#activity labels
activityLabels<-read.table("C:/Users/Doug/dropbox/r/data/UCI HAR Dataset/activity_labels.txt")
